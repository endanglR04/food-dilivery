...
<html lang="en">
                                        ...
                                        <div role="tabpanel" id="menu1" class="tab-pane fade in active">
                                            <table class="table table-hoever table-sm">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>GET</td>
                                                        <td>http://localhost/food-dilivery/getKategori.php?kategori=nasi</td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
    ...
    curl --request GET \
         --url 'http://localhost/food-dilivery/getKategori.php?kategori=nasi' \
   ...
   &lt;?php
    ...
    curl_setopt_array($curl, array(
      CURLOPT_URL => "http://localhost/food-dilivery/getKategori.php?kategori=nasi",
                                            ...
                                            <div role="tabpanel" id="menu4" class="tab-pane fade in active">
                                                <table class="table table-hoever table-sm">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td>GET</td>
                                                            <td>http://localhost/food-dilivery/getAllmenu.php</td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
    ...
    curl --request GET \
         --url 'http://localhost/food-dilivery/getAllmenu.php' \
         --header 'api-key: your-api-key'                                                     
                                                        </pre>
                                                    </div>
   ...
   &lt;?php
    ...
    curl_setopt_array($curl, array(
      CURLOPT_URL => "http://localhost/food-dilivery/getAllmenu.php",
      CURLOPT_RETURNTRANSFER => true,
      CURLOPT_ENCODING => "",
      CURLOPT_MAXREDIRS => 10,
      CURLOPT_TIMEOUT => 30,
